                    ...
                    <fieldset class='fieldset'>
                        ...
                        <div class='row'>
                            <div class='medium-6 columns'>     
                                <label> Nombre de usuario
                                    <s:textfield name="username" key="Usuario" cssClass='input-group-field'/> 
                                </label>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='medium-6 columns'>
                                <label> Contraseña
                                    <s:password name="password" key="Contraseña" cssClass='input-group-field' cssClass='input-group-field'/>  
                                </label>
                            </div>
                            <div class='medium-6 columns'>
                                <label> Confirmación de Contraseña
                                    <s:password name="password_confirmation" key="Confirmar contraseña" cssClass='input-group-field'/> 
                                </label>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='medium-12 columns'>
                                <label> Correo electrónico
                                    <s:textfield name="email" key="Correo electrónico" cssClass='input-group-field'/> 
                                </label>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='medium-6 columns'>
                                <label> Nombre(s)
                                    <s:textfield name="firstname" key="Nombre(s)" cssClass='input-group-field'/> 
                                </label>
                            </div>
                            <div class='medium-6 columns'>
                                <label>Apellidos
                                    <s:textfield name="lastname" key="Apellidos" cssClass='input-group-field'/> 
                                </label>
                            </div>
                        </div>
                        <div class='row'>
                        ...
                        <div class='row'>
                            <div class='medium-12 columns'>
                                <label>
                                    <br />
                                    <s:submit value="Registrar Nuevo Usuario" cssClass='button expanded'/>
                                </label>
                            </div>
                        </div>
                    </fieldset>
